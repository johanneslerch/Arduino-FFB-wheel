...
class Joystick_
{
  public:
    ...
    void send_16_16_12_12_12_12_32_32(int16_t x, uint16_t y, uint16_t z, uint16_t rx, uint16_t ry, uint16_t rz, uint32_t buttons, uint32_t buttons2); // JL, added this one
